            ...
            options: {
                ...
                particles: {
                    ...
                    move: {
                        ...
                        speed: { min: 1, max: 3 }, // using a range in speed value will make particles move in a random speed between min/max values, each particle has its own value, it won't change over time by default
                    },
                    number: {
                        value: 100,
                    },
